...
public class SearchAction extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		if (user != null) {
			...
			// this.products =
			// productManager.getProductsForSearchValues(this.searchDescription,
			// this.searchMinPrice, this.searchMaxPrice);
			...
			for (Product foundProduct : productManager.getProductsForSearchValues(this.searchDescription, sMinPrice,
					sMaxPrice)) {
				Category category = categoryManager.getCategory(foundProduct.getCategoryId());
				Product mappedProduct = new Product(foundProduct.getName(), foundProduct.getPrice(), category,
						foundProduct.getDetails());
				mappedProduct.setId(foundProduct.getId());
